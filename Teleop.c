...
#pragma config(Motor,  mtr_S3_C3_1,     greenlight,    tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S3_C3_2,     redlight,      tmotorTetrix, openLoop)
#pragma config(Servo,  srvo_S3_C4_1,    claw,                 tServoStandard)
#pragma config(Servo,  srvo_S3_C4_2,    LeftBooster,          tServoStandard)
#pragma config(Servo,  srvo_S3_C4_3,    RightBooster,         tServoStandard)
#pragma config(Servo,  srvo_S3_C4_4,    ClawRelease,          tServoNone)
#pragma config(Servo,  srvo_S3_C4_5,    leftgrab,               tServoNone)
#pragma config(Servo,  srvo_S3_C4_6,    rightgrab,               tServoNone)
...
void doGunning()
{
	...
	if(joy2Btn(Releaseboosterbtn)){
		servo[RightBooster] = 180;
		servo[LeftBooster] = 100;
	}
